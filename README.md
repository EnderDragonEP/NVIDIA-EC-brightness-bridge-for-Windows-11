...
This happens because you are not using the display drivers that is shipped with your laptop, and Windows somehow fails to forward brightness adjustments to the NVIDIA driver that is currently driving the built-in display.
